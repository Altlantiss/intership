...
initJqGrid({
    ...
    key: 'id',
    urlCreater: 'mobile/dailyPaper/school?type=1&state=2&',
    beforeRequest: function () {
        ...
        var newUrl = apiUrl + "mobile/dailyPaper/school?type=1&state=2&page=" + currentpage + "&limit=" + rowNum + "&token=" + cookie.get("token");
        if(studentName !== ""){
