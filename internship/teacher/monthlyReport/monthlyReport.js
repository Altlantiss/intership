...
initJqGrid({
    ...
    key: 'id',
    urlCreater: 'mobile/dailyPaper/school?type=2&state=1&',
    beforeRequest: function () {
        ...
        var newUrl = apiUrl + "mobile/dailyPaper/school?type=2&state=1&page=" + currentpage + "&limit=" + rowNum + "&token=" + cookie.get("token");
        if(studentName !== ""){
