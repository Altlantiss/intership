...
//
// // 审批通过
// function canApproval(id) {
//
//     $.ajax({
//         url: apiUrl + '/mobile/practiceChange/approval',
//         type: 'PUT',
//         data: {
//             id: id,
//             state: 1,
...
initJqGrid({
    ...
    key: 'id',
    urlCreater: 'mobile/practiceChange/school?',
    beforeRequest: function () {
        ...
        var newUrl = apiUrl + "/mobile/practiceChange/school?page=" + currentpage + "&limit=" + rowNum + "&token=" + cookie.get("token");
        if(studentName !== ""){
...
function approve_fn(e) {
    ...
    my_alert('提示', '审批通过？', true, function () {
        ...
        $.ajax({
            ...
            url: apiUrl + 'mobile/practiceChange/approval?id=' + id + '&state=' + 1,
            success: function (data) {
                if (data['code'] === 0) {
...
function noapprove_fn(e) {
    ...
    my_alert('提示', '审批不通过？', true, function () {
        ...
        $.ajax({
            ...
            url: apiUrl + 'mobile/practiceChange/approval?id=' + id + '&state=' + 2,
            success: function (data) {
                if (data['code'] === 0) {
                    my_alert('提示', '提交成功', true, reloadJqGrid);
                } else {
