            ...
            if (data['code'] == 0) {
                ...
                if (json) {
                    ...
                    $.each(json, function (i, item) {
                        ...
                        list += "<td class='tit'>" + item.userNo + "</td>";
                        list += "<td class='cont' title="+ item.school +">" + item.departName + "</td>";
                        list += "<td>" + item.majorName + "</td>";
                        list += "<td>" + item.className + "</td></tr>";
                    });
                }
...
$('#return').click(function () {
    ...
    window.location.href = 'http://101.37.27.185:8080/dingang/practiceArrange.html'
...
$('#sendNoticeBtn').click(function () {
    ...
    window.location.href = 'http://101.37.27.185:8080/dingang/arrangePage.html'
